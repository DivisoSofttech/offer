...
import { OfferDayComponent } from 'app/entities/Offer/offer-day/offer-day.component';
...
describe('Component Tests', () => {
  describe('OfferDay Management Component', () => {
    let comp: OfferDayComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OfferDayComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.offerDays[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
